...
'$C_{n_{\delta r}}$'
    ...
    #     # print(globnames[i])
    #     print(round(glob[i],5))


    # print(CZde,Cmde)
    # for i in range(len(symmnames)):
        # print(round(symm[i],5))
        # print(symmnames[i])


    for i in range(len(asymmnames)):
        print(round(asymm[i],5))
        # print(asymmnames[i])
...
# # Main inputs:
# coeff = aeroloader.loadaero         ('Aero_output/v12k/v12steadywithtail.xlsx')
# coeff_notail = aeroloader.loadaero  ('Aero_output/v12k/v12steadynotail.xlsx')
...
# # ShS = 0.112904467    # Ratio of the horizontal tail area over the main wing area
# b = 0.774596669 # Span
# c = 0.064549722 # MAC
# shift = 0*c/2 # CG shift
# incidence_h = -0*np.pi/180 # Tail incidence angle
# m = 0.752727317 # mass
# x_lemac = 0.151930075 # Leading edge of MAC
# xcg = 0.164836095+shift # CG location
# xac = 0.16137931
