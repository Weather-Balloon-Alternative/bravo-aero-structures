...
coeff = aeroloader.loadaero('Aero_output/v7/glider_v7.xlsx',discard=False)
coeff_notail = aeroloader.loadaero('Aero_output/v7/glider_v7_wingonly.xlsx',discard=False)
